...
It starts since 1 by default, now with --installed
...
It accepts start as the first arguments, with --installed
...
It accepst end as the second argument, with --installed

  $ run_it --installed 7 4
